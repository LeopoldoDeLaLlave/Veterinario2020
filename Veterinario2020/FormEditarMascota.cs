...
namespace Veterinario2020
{
    ...
    public partial class FormEditarMascota : Form
    {
        ...
        DataGridView aux = new DataGridView();//El datagrid view que se muestra en los datos de usuario con sus mascotas, para modificarlo
        ...
        {
            FormConfirmarEliminarMascota fcem = new FormConfirmarEliminarMascota(chip, aux, dglistaMascotas, datosMascota.Rows[0]["propietario"].ToString());
            fcem.ShowDialog();
            this.Hide();
        }
    }
